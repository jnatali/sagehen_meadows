...
setwd("/Users/play/Desktop/phenocam/phenopix/RGB")

# Create folders for different outputs
my.path <- structureFolder(path=getwd(), showWarnings=TRUE)

path_img_ref <- "/Users/play/Desktop/phenocam/phenopix/RGB/REF/RENAMED"
roi.path <- "/Users/play/Desktop/phenocam/phenopix/RGB/ROI/"
img.path <- "/Users/play/Desktop/phenocam/phenopix/RGB/IMG/"
vi.path <- "/Users/play/Desktop/phenocam/phenopix/RGB/VI/"
