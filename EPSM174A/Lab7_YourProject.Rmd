...
```{r code chunk 1}
library(MARSS)
dat <- as.matrix(read.csv("C:/Users/Hugh/Desktop/Riverlab/groundwater_binned_by_BIWEEK.csv"), stringsAsFactors=FALSE, header=FALSE)

#don't want to zscone bi_week_fac
by_week_fac <- dat[,2]

transformed_dat <- zscore(dat)
transformed_dat[,2] <- by_week_fac
